...
const RightClickMenu = (props) => {
	...
	const moveBox = !inlineMode ? (props.moveBox || [50,-9]) : [0,0]
	...
	if((showModal && props.enableModal) || props.forceModal) { //for Mobile
		...
		if(parentPosition && !inlineMode) {
			positionScreenY += parentPosition.height
			TOP += parentPosition.height
		}
		console.log(positionScreenY);
		console.log(menu.height);
		console.log(page.height)
		console.log(rightClickDOMNode.getBoundingClientRect())
