...
class InputCellDisplay extends Component {
  ...
  render() {
    if (this.props.errorText !== null) {
      return (
        <div className="cell-container no-select cell-error">
    ...
    return <div className="cell-container no-select"><p style={this.props.style} className="cell-text">{this.props.data}</p></div>;
  }
}
